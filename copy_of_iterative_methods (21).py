...
Original file is located at
    https://colab.research.google.com/drive/1zbvyU1NCYYsSymS-HgBWwi-eJV_i1P7F
...
def jacobi1_iteration(x,y): 
    ...
    x_new = (1/7)*(6+y)
    y_new = (1/5)*(x+4)
    return [x_new, y_new] # Your return statement should return a list of the form [new_x,new_y]
...
def gs3_iteration(x,y,z): 
    ...
    list = []
    x_new = (1/5)*(2*y-(3*z) - 8)
    y_new = (1/4)*(-1*x_new +(4*z) + 102)
    z_new = (1/4)*(2*x_new +(2*y_new) - 90)
